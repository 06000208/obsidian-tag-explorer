    ...
    plugins: [
        del({
            ...
            targets: [
                ...
                "build/styles.css",
                "build/manifest.json",
                // "test-vault/.obsidian/plugins/tag-explorer/main.js",
                // "test-vault/.obsidian/plugins/tag-explorer/styles.css",
                // "test-vault/.obsidian/plugins/tag-explorer/manifest.json",
            ],
            verbose: true,
        }),
        typescript(),
        ...
        copy({
            hook: "writeBundle",
            targets: [
                { src: "build/*", dest: "test-vault/.obsidian/plugins/tag-explorer/" },
            ],
        }),
    ],
};
